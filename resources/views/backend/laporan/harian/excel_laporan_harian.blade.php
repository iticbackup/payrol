    ...
    <table>
            ...
            @endphp
                <tr>
                    ...
                    {{-- @php
                        ...
                        $total_gaji = $pengerjaan_harian->upah_dasar_weekly+$total_plus;
                        // $total_gaji = $pengerjaan_harian->upah_dasar_weekly+$total_plus+$lembur;
        ...
        <tfoot>
            <tr>
                ...
                {{-- @foreach ($hasil_kerjas as $hsk => $hasil_kerja)
                @if ($hasil_kerja != null)
                    <td style="text-align: center; border: 1px solid black; font-weight: bold">{{ $hasil_kerja }}</td>
                @endif
                @endforeach --}}
                ...
                @php
                    ...
                    foreach ($pengerjaan_harians as $key => $pengerjaan_harian) {
                        $explode_hasil_kerja = explode("|",$pengerjaan_harian->hasil_kerja);
                        $hasil_kerja = array_push($total_hari_jam_kerja,$explode_hasil_kerja[$et]);
