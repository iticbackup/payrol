    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title m-0" id="exampleModalCenterTitle">Edit Data UMK Borongan Ekspor</h6>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="edit_umk_etiket" id="edit_umk_etiket" placeholder="UMK Etiket">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                            <label class="form-label">UMK Las Tepi</label>
                            <input type="text" class="form-control" name="edit_umk_las_tepi" id="edit_umk_las_tepi" placeholder="UMK Las Tepi">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                            <label class="form-label">UMK Las Pojok</label>
                            <input type="text" class="form-control" name="edit_umk_las_pojok" id="edit_umk_las_pojok" placeholder="UMK Las Pojok">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                            <label class="form-label">UMK Ambri</label>
                            <input type="text" class="form-control" name="edit_umk_ambri" id="edit_umk_ambri" placeholder="UMK Ambri">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
