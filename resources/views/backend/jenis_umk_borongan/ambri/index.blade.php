...
@section('content')
    ...
    @include('backend.jenis_umk_borongan.ambri.modalBuat')
    @include('backend.jenis_umk_borongan.ambri.modalEdit')
...
@section('script')
    ...
    <script>
        ...
        var table = $('#datatables').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('jenis_umk_borongan.ambri') }}",
            columns: [
                {
                    data: 'jenis_produk',
                    name: 'jenis_produk'
        ...
        function edit(id) {
            var url = '{{ route('jenis_umk_borongan.ambri.detail', ':id') }}';
            ...
            $.ajax({
                ...
                success: (result) => {
                    ...
                    $('#edit_umk_etiket').val(result.data.umk_etiket);
                    $('#edit_umk_las_tepi').val(result.data.umk_las_tepi);
                    $('#edit_umk_las_pojok').val(result.data.umk_las_pojok);
                    $('#edit_umk_ambri').val(result.data.umk_ambri);
        ...
        function hapus(id) {
            var url = '{{ route('jenis_umk_borongan.ambri.delete', ':id') }}';
            url = url.replace(':id', id);
        ...
        $('#form-simpan').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('jenis_umk_borongan.ambri.simpan') }}",
                data: formData,
                contentType: false,
                processData: false,
                success: (result) => {
        ...
        $('#form-update').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('jenis_umk_borongan.ambri.update') }}",
                data: formData,
                contentType: false,
                processData: false,
                success: (result) => {
