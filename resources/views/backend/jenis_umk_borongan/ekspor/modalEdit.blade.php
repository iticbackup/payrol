        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label class="form-label">UMK Kemas</label>
                            <input type="text" class="form-control" name="edit_umk_kemas" id="edit_umk_kemas" placeholder="UMK Kemas">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label class="form-label">UMK Pilih Gagang</label>
                            <input type="text" class="form-control" name="edit_umk_pilih_gagang" id="edit_umk_pilih_gagang" placeholder="UMK Inner">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
