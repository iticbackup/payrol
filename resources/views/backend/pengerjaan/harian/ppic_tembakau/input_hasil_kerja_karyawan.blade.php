...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                {{-- <form action="{{ route('hasil_kerja.ppicTembakau.simpan',['id' => $id, 'nik' => $nik, 'kode_pengerjaan' => $kode_pengerjaan, 'month' => $month, 'year' => $year]) }}" method="post" enctype="multipart/form-data"> --}}
