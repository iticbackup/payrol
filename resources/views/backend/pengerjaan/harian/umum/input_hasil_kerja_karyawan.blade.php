...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                {{-- <form action="{{ route('hasil_kerja.umum.simpan',['id' => $id, 'nik' => $nik, 'kode_pengerjaan' => $kode_pengerjaan, 'month' => $month, 'year' => $year]) }}" method="post" enctype="multipart/form-data"> --}}
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <label class="col-sm-10 form-label align-self-center mb-lg-0">Hari
                                                                Terlambat <u>></u> 5 Menit <u><</u> 15 Menit</label>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
...
@section('script')
    ...
    <script>
        $('#form-simpan').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ url('pengerjaan/hasil_kerja/umum/' . $id. '/' . $kode_pengerjaan . '/' .$nik. '/' .$month. '/' .$year . '/input_hasil/simpan') }}",
                data: formData,
                contentType: false,
                processData: false,
                success: (result) => {
