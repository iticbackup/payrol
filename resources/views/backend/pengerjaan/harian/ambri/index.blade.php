        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('hasil_kerja.ambri.tambah_karyawan',['id' => $jenis_operator_detail_pekerjaan->jenis_operator_detail_id, 'kode_pengerjaan' => $new_data_pengerjaan->kode_pengerjaan ]) }}" class="btn btn-primary">Tambah Karyawan</a>
                </div>
                <div class="card-body">
                        ...
                        <table id="datatables" class="table table-sm table-bordered dt-responsive nowrap"
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    {{-- @foreach ($explode_tanggal_pengerjaans as $key => $explode_tanggal_pengerjaan)
                                    @if ($key != 0)
                                    <td class="text-center" style="font-weight: bold" id="val{{ $key }}"></td>
                                    @endif
                                    @endforeach --}}
