...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                {{-- <form action="{{ route('hasil_kerja.ambri.simpan',['id' => $id, 'nik' => $nik, 'kode_pengerjaan' => $kode_pengerjaan, 'month' => $month, 'year' => $year]) }}" method="post" enctype="multipart/form-data"> --}}
...
@section('script')
    ...
    <script>
        $('#form-simpan').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ url('pengerjaan/hasil_kerja/ambri/' . $id. '/' . $kode_pengerjaan . '/' .$nik. '/' .$month. '/' .$year . '/input_hasil/simpan') }}",
                data: formData,
                contentType: false,
                processData: false,
                success: (result) => {
