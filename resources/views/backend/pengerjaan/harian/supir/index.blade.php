        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('hasil_kerja.supir.tambah_karyawan',['id' => $jenis_operator_detail_pekerjaan->jenis_operator_detail_id, 'kode_pengerjaan' => $new_data_pengerjaan->kode_pengerjaan ]) }}" class="btn btn-primary">Tambah Karyawan</a>
                    @endif
                </div>
                <div class="card-body">
