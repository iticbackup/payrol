                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input type="text" class="form-control"
                                                                value="{{ number_format($pulang_2*75000,0,',','.') }}" id="" readonly>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input type="text" class="form-control"
                                                                value="{{ number_format($telat_5*75000,0,',','.') }}" id="" readonly>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="hidden" name="pot_tunjangan_kehadiran" value="{{ $total_potongan_tk }}" class="form-control">
                                                </td>
                                            </tr>
                                            @endif
                                            <tr>
