...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                {{-- <form action="{{ route('hasil_kerja.supir.simpan',['id' => $id, 'nik' => $nik, 'kode_pengerjaan' => $kode_pengerjaan, 'month' => $month, 'year' => $year]) }}" method="post" enctype="multipart/form-data"> --}}
                                    ...
                                    <div class="card-body">
                                        <table class="table table-bordered">
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="hidden" name="operator_harian_karyawan_id" value="{{ $karyawan_harian->id }}">
                                                    {{ $karyawan_harian->nik }}
                                                    {{-- @php
                                                        dd($karyawan_harian['hari_kerja']);
                                                    @endphp --}}
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="keterangan_plus_1" class="form-control"
                                                            placeholder="Keterangan" value="{{ $keterangan_plus_1 }}" id="">
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <input type="text" name="plus_2" value="{{ $hasil_plus_2 }}" class="form-control"
                                                            placeholder="Rp." id="">
                                                        <input type="text" name="keterangan_plus_2" value="{{ $keterangan_plus_2 }}" class="form-control"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <input type="text" name="plus_3" value="{{ $hasil_plus_3 }}" class="form-control"
                                                            placeholder="Rp." id="">
                                                        <input type="text" name="keterangan_plus_3" value="{{ $keterangan_plus_3 }}" class="form-control"
                                                            placeholder="Keterangan" id="">
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div class="col-md-5"><input type="text" class="form-control" value="{{ $hasil_lembur_1 }}" name="lembur_1" id=""></div>
                                                        <div class="col-md-1">-</div>
                                                        <div class="col-md-5"><input type="text" class="form-control" value="{{ $hasil_lembur_2 }}" name="lembur_2" id=""></div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    placeholder="Uang Makan" value="{{ $karyawan_harian->uang_makan }}" id="">
                                                </td>
                                            </tr>
                                            {{-- @php
                                            ...
                                            @endphp
                                            @php
                                                // $absensi_terlambat = \App\Models\PresensiInfo::where('scan_date','LIKE',"%2023-09-30%")
                                                //                                     ->where('pin',$karyawan_harian->pin)
                                                //                                     ->where('status',3)
                                                //                                     ->first();
                                                // dd($absensi_terlambat);
                                                // $presensi = \App\Models\PresensiInfo::where('scan_date','LIKE',"%2023-09-29%")
                                                //                                         ->where('pin',$karyawan_harian->pin)
                                            ...
                                            @for ($b=1;$b<=$a;$b++)
                                                @php
                                                    ...
                                                    if(empty($absensi_terlambat)){
                                                        ...
                                                        if(empty($exp_keterangan_terlambat[1]) && empty($exp_keterangan_terlambat[2]) && empty($exp_keterangan_terlambat[3])){
                                                            ...
                                                            $jam_dtg_terlambat=strtotime(\Carbon\Carbon::parse($absensi_terlambat->scan_date)->format('H:i'));
                                                    ...
                                                    $checklog = \App\Models\FtmAttLog::where('scan_date','LIKE',"%$tgl_digunakan%")
                                                                                    ->where('pin',$karyawan_harian->pin);
                                                    ...
                                                    // if(empty($checklog)||(empty($presensi))){
                                                        ...
                                                        // dd($jam_kerja_seharusnya-$total_ijin_km-$total_absensi_terlambat-$total_jumlah_plg_awal_pribadi_plg_awal_sakit);
                                                        $jam_kerja=$jam_kerja_seharusnya-$total_ijin_km-$total_absensi_terlambat-$total_jumlah_plg_awal_pribadi_plg_awal_sakit;
                                                        // dd($jam_kerja_seharusnya-$total_ijin_km-$total_absensi_terlambat);
                                                        // dd(explode(".",$jam_kerja));
                                                ...
                                                @endphp
                                                <tr>
                                                    <td style="font-weight: bold">{{ \Carbon\Carbon::parse($tgl_digunakan)->format('d-m-Y') }}</td>
                                                    <td class="text-center">:</td>
                                                    <td>
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-floating">
                                                                    <input type="text" class="form-control text-center" name="jam_kerja_{{ $b }}" value="{{ round($post_jam_kerja,4) }}" id="">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input type="text" class="form-control"
                                                                value="{{ number_format(75000*$alpa->count(),0,',','.') }}" id="" >
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input type="text" class="form-control"
                                                                value="{{ number_format(75000*$diliburkan->count(),0,',','.') }}" id="" >
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input type="text" class="form-control"
                                                                value="{{ number_format(75000*$sakit->count(),0,',','.') }}" id="" >
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input type="text" class="form-control"
                                                                value="{{ number_format(75000*$cuti->count(),0,',','.') }}" id="" >
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input type="text" class="form-control"
                                                                value="{{ number_format(75000*$ijin_full->count(),0,',','.') }}" id="" >
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input type="text" class="form-control"
                                                                value="{{ number_format($ijin_15*25000,0,',','.') }}" id="" >
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input type="text" class="form-control"
                                                                value="{{ number_format($ijin_k4*40000,0,',','.') }}" id="" >
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input type="text" class="form-control"
                                                                value="{{ number_format($ijin_k4*75000,0,',','.') }}" id="" >
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input type="text" class="form-control"
                                                                value="{{ number_format($pulang_1*40000,0,',','.') }}" id="" >
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input type="text" class="form-control"
                                                                value="{{ number_format($pulang_2*75000,0,',','.') }}" id="" >
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input type="text" class="form-control"
                                                                value="{{ number_format($telat_1*15000,0,',','.') }}" id="" >
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input type="text" class="form-control"
                                                                value="{{ number_format($telat_2*25000,0,',','.') }}" id="" >
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input type="text" class="form-control"
                                                                value="{{ number_format($telat_3*30000,0,',','.') }}" id="" >
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input type="text" class="form-control"
                                                                value="{{ number_format($telat_4*40000,0,',','.') }}" id="" >
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="text" name="pot_tunjangan_kehadiran" value="{{ $total_potongan_tk }}" class="form-control">
                                                </td>
                                            </tr>
                                            @endif
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2">
                                                    <input type="text" name="minus_1" value="{{ $hasil_minus_1 }}" class="form-control"
                                                        placeholder="Rp" id="">
                                                    <input type="text" name="keterangan_minus_1" value="{{ $keterangan_minus_1 }}" class="form-control"
                                                        placeholder="Keterangan" id="">
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td colspan="2">
                                                    <input type="text" name="minus_2" value="{{ $hasil_minus_2 }}" class="form-control"
                                                        placeholder="Rp" id="">
                                                    <input type="text" name="keterangan_minus_2" value="{{ $keterangan_minus_2 }}" class="form-control"
                                                        placeholder="Keterangan" id="">
                                                </td>
                                            </tr>
                                        </table>
...
@section('script')
    ...
    <script>
        $('#form-simpan').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ url('pengerjaan/hasil_kerja/supir/' . $id. '/' . $kode_pengerjaan . '/' .$nik. '/' .$month. '/' .$year . '/input_hasil/simpan') }}",
                data: formData,
                contentType: false,
                processData: false,
                success: (result) => {
