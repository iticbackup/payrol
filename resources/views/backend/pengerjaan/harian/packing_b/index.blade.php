            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-container">
                        <table id="datatables" class="table table-sm table-bordered nowrap"
