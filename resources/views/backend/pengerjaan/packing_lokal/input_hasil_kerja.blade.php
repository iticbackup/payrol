...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                {{-- <form action="{{ route('hasil_kerja.packingLokal.view_hasil.simpan',['id' => $id, 'kode_pengerjaan' => $kode_pengerjaan, 'tanggal' => $tanggal]) }}" method="post" enctype="multipart/form-data"> --}}
                ...
                <div class="card-body">
                    ...
                    style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        <thead>
                            ...
                            <?php 
                                // $umk_borongan_lokal_kerja = \App\Models\Pengerjaan::where('tanggal_pengerjaan',$tanggal)->first();
                            ...
                            <tr>
                                <th class="text-center" style="width: 10%">
                                    <select name="umk_borongan_lokal_kerja_1" class="form-control" id="">
                                        ...
                                        @foreach ($umk_borongan_lokals as $umk_borongan_lokal)
                                            <option value="{{ $umk_borongan_lokal->id }}" {{ $umk_borongan_lokal->id == $select_umk_borongan_lokal_1 ? 'selected' : null }}>{{ $umk_borongan_lokal->jenis_produk }} - Rp {{ $umk_borongan_lokal->umk_packing }}</option>
                                        @endforeach
                                    </select>
                                </th>
                                ...
                                <th class="text-center" style="width: 10%">
                                    <select name="umk_borongan_lokal_kerja_2" class="form-control" id="">
                                        <option value="">-- Pilih --</option>
                                        @foreach ($umk_borongan_lokals as $umk_borongan_lokal)
                                            <option value="{{ $umk_borongan_lokal->id }}" {{ $umk_borongan_lokal->id == $select_umk_borongan_lokal_2 ? 'selected' : null }}>{{ $umk_borongan_lokal->jenis_produk }} - Rp {{ $umk_borongan_lokal->umk_packing }}</option>
                                        @endforeach
                                    </select>
                                </th>
                                <th class="text-center">
                                ...
                                <th class="text-center" style="width: 10%">
                                    <select name="umk_borongan_lokal_kerja_3" class="form-control" id="">
                                        <option value="">-- Pilih --</option>
                                        @foreach ($umk_borongan_lokals as $umk_borongan_lokal)
                                            <option value="{{ $umk_borongan_lokal->id }}" {{ $umk_borongan_lokal->id == $select_umk_borongan_lokal_3 ? 'selected' : null }}>{{ $umk_borongan_lokal->jenis_produk }} - Rp {{ $umk_borongan_lokal->umk_packing }}</option>
                                        @endforeach
                                    </select>
                                </th>
                                <th class="text-center">
                                ...
                                <th class="text-center" style="width: 10%">
                                    <select name="umk_borongan_lokal_kerja_4" class="form-control" id="">
                                        <option value="">-- Pilih --</option>
                                        @foreach ($umk_borongan_lokals as $umk_borongan_lokal)
                                            <option value="{{ $umk_borongan_lokal->id }}" {{ $umk_borongan_lokal->id == $select_umk_borongan_lokal_4 ? 'selected' : null }}>{{ $umk_borongan_lokal->jenis_produk }} - Rp {{ $umk_borongan_lokal->umk_packing }}</option>
                                        @endforeach
                                    </select>
                                </th>
                                <th class="text-center">
                                ...
                                <th class="text-center" style="width: 10%">
                                    <select name="umk_borongan_lokal_kerja_5" class="form-control" id="">
                                        <option value="">-- Pilih --</option>
                                        @foreach ($umk_borongan_lokals as $umk_borongan_lokal)
                                            <option value="{{ $umk_borongan_lokal->id }}" {{ $umk_borongan_lokal->id == $select_umk_borongan_lokal_5 ? 'selected' : null }}>{{ $umk_borongan_lokal->jenis_produk }} - Rp {{ $umk_borongan_lokal->umk_packing }}</option>
                                        @endforeach
                                    </select>
                                </th>
                                <th class="text-center">
                        ...
                        <tbody>
                            @foreach ($packing_lokals as $key=> $packing_lokal)
                                ...
                                <tr>
                                    ...
                                    <td style="width: 5%">
                                        <div class="input-group">
                                            <input type="text" name="total_jam_1[]" value="{{ $packing_lokal->total_jam_kerja_1 }}" class="form-control titik_koma" style="background-color: #E1ECC8; text-align: center">
                                            {{-- <span class="input-group-text" id="basic-addon2">Jam</span> --}}
                                        </div>
                                    </td>
                                    ...
                                    <td style="width: 5%">
                                        <div class="input-group">
                                            <input type="text" name="total_jam_2[]" value="{{ $packing_lokal->total_jam_kerja_2 }}" class="form-control" style="background-color: #E1ECC8; text-align: center">
                                            {{-- <span class="input-group-text" id="basic-addon2">Jam</span> --}}
                                        </div>
                                    </td>
                                    ...
                                    <td style="width: 5%">
                                        <div class="input-group">
                                            <input type="text" name="total_jam_3[]" value="{{ $packing_lokal->total_jam_kerja_3 }}" class="form-control" style="background-color: #E1ECC8; text-align: center">
                                            {{-- <span class="input-group-text" id="basic-addon2">Jam</span> --}}
                                        </div>
                                    </td>
                                    ...
                                    <td style="width: 5%">
                                        <div class="input-group">
                                            <input type="text" name="total_jam_4[]" value="{{ $packing_lokal->total_jam_kerja_4 }}" class="form-control" style="background-color: #E1ECC8; text-align: center">
                                            {{-- <span class="input-group-text" id="basic-addon2">Jam</span> --}}
                                        </div>
                                    </td>
                                    ...
                                    <td style="width: 5%">
                                        <div class="input-group">
                                            <input type="text" name="total_jam_5[]" value="{{ $packing_lokal->total_jam_kerja_5 }}" class="form-control" style="background-color: #E1ECC8; text-align: center">
                                            {{-- <span class="input-group-text" id="basic-addon2">Jam</span> --}}
                                        </div>
                                    </td>
                                </tr>
...
<script>
    ...
    $('#form-simpan').submit(function(e) {
        ...
        $.ajax({
            type:'POST',
            url:"{{ url('pengerjaan/hasil_kerja/packing_lokal/'.$id.'/'.$kode_pengerjaan.'/'.$tanggal.'/input_hasil/simpan') }}",
            data: formData,
            contentType: false,
            processData: false,
            success: (result) => {
