                                            ...
                                            <td>
                                                <table class="table table-bordered" style="width: 100%">
                                                    ...
                                                    {{-- <tr>
                                                        ...
                                                        <td style="font-size: 8pt" class="text-primary">{{ $data_explode_hasil_kerja_1 }}</td>
                                                        <td style="font-size: 8pt">{{ $hasil_pengerjaan->total_jam_kerja_1 }}Jam</td>
                                                        <td style="font-size: 8pt" class="text-danger">{{ $jenis_produk_2 }}</td>
                                                        <td style="font-size: 8pt" class="text-primary">{{ $data_explode_hasil_kerja_2 }}</td>
                                                        <td style="font-size: 8pt">{{ $hasil_pengerjaan->total_jam_kerja_2 }}Jam</td>
                                                        <td style="font-size: 8pt" class="text-danger">{{ $jenis_produk_3 }}</td>
                                                        <td style="font-size: 8pt" class="text-primary">{{ $data_explode_hasil_kerja_3 }}</td>
                                                        <td style="font-size: 8pt">{{ $hasil_pengerjaan->total_jam_kerja_3 }}Jam</td>
                                                        <td style="font-size: 8pt" class="text-danger">{{ $jenis_produk_4 }}</td>
                                                        <td style="font-size: 8pt" class="text-primary">{{ $data_explode_hasil_kerja_4 }}</td>
                                                        <td style="font-size: 8pt">{{ $hasil_pengerjaan->total_jam_kerja_4 }}Jam</td>
                                                        <td style="font-size: 8pt" class="text-danger">{{ $jenis_produk_5 }}</td>
                                                        <td style="font-size: 8pt" class="text-primary">{{ $data_explode_hasil_kerja_5 }}</td>
                                                        <td style="font-size: 8pt">{{ $hasil_pengerjaan->total_jam_kerja_5 }}Jam</td>
                                                    </tr> --}}
                                                </table>
                                                {{-- <span style="font-size: 8pt" class="text-danger">{{ $jenis_produk_1 }}</span> - <span style="font-size: 8pt" class="text-primary">{{ $data_explode_hasil_kerja_1 }}</span> - <span style="font-size: 8pt">{{ $hasil_pengerjaan->total_jam_kerja_1 }}</span> |
                                                <span style="font-size: 8pt" class="text-danger">{{ $jenis_produk_2 }}</span> - <span style="font-size: 8pt" class="text-primary">{{ $data_explode_hasil_kerja_2 }}</span> - <span style="font-size: 8pt">{{ $hasil_pengerjaan->total_jam_kerja_2 }}</span> |
                                                <span style="font-size: 8pt" class="text-danger">{{ $jenis_produk_3 }}</span> - <span style="font-size: 8pt" class="text-primary">{{ $data_explode_hasil_kerja_3 }}</span> - <span style="font-size: 8pt">{{ $hasil_pengerjaan->total_jam_kerja_3 }}</span> |
                                                <span style="font-size: 8pt" class="text-danger">{{ $jenis_produk_4 }}</span> - <span style="font-size: 8pt" class="text-primary">{{ $data_explode_hasil_kerja_4 }}</span> - <span style="font-size: 8pt">{{ $hasil_pengerjaan->total_jam_kerja_4 }}</span> |
