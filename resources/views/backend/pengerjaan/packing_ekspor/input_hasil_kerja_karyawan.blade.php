...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                {{-- <form action="{{ route('hasil_kerja.packingEkspor.view_hasil_karyawan.simpan',['id' => $id, 'kode_pengerjaan' => $kode_pengerjaan,'nik' => $nik]) }}" method="post" enctype="multipart/form-data"> --}}
                                    ...
                                    <div class="card-body">
                                        <table class="table table-bordered">
                                            ...
                                            if (empty($pengerjaan_weekly->plus_3)) {
                                                ...
                                                $explode_plus_2 = explode('|', $pengerjaan_weekly->plus_3);
...
@section('script')
    ...
    <script>
        $('#form-simpan').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ url('pengerjaan/hasil_kerja/packing_ekspor/' . $id . '/' . $kode_pengerjaan . '/' . $nik . '/input_hasil_karyawan/simpan') }}",
                data: formData,
                contentType: false,
                processData: false,
                success: (result) => {
