                                ...
                                ?>
                                    <tr>
                                        ...
                                        <?php 
                                            ...
                                            $umk_borongan_lokal_1 = \App\Models\UMKBoronganEkspor::select('id','jenis_produk','umk_packing','umk_kemas','umk_pilih_gagang')->where('id',$explode_hasil_kerja_1[0])->where('status','Y')->first();
                                            ...
                                            $umk_borongan_lokal_2 = \App\Models\UMKBoronganEkspor::select('id','jenis_produk','umk_packing','umk_kemas','umk_pilih_gagang')->where('id',$explode_hasil_kerja_2[0])->where('status','Y')->first();
                                            ...
                                            $umk_borongan_lokal_3 = \App\Models\UMKBoronganEkspor::select('id','jenis_produk','umk_packing','umk_kemas','umk_pilih_gagang')->where('id',$explode_hasil_kerja_3[0])->where('status','Y')->first();
                                            ...
                                            $umk_borongan_lokal_4 = \App\Models\UMKBoronganEkspor::select('id','jenis_produk','umk_packing','umk_kemas','umk_pilih_gagang')->where('id',$explode_hasil_kerja_4[0])->where('status','Y')->first();
                                            ...
                                            $umk_borongan_lokal_5 = \App\Models\UMKBoronganEkspor::select('id','jenis_produk','umk_packing','umk_kemas','umk_pilih_gagang')->where('id',$explode_hasil_kerja_5[0])->where('status','Y')->first();
                                        ...
                                        <?php 
                                            ...
                                            if(empty($pengerjaan->tunjangan_kehadiran)){
                                                ...
                                                $tunjangan_kehadiran = number_format($pengerjaan->tunjangan_kehadiran,0,',','.');
                                            }
                                        ...
                                        @if ($new_data_pengerjaan->akhir_bulan == $akhir_bulan)
                                        <td style="text-align: right">{{ $tunjangan_kerja }}</td>
                                        <td style="text-align: right">{{ $tunjangan_kehadiran }}</td>
                                        @endif
                                        <?php 
                                        ...
                                        foreach ($hasil_pengerjaans as $hp => $hasil_pengerjaan) {
                                            if (empty($hasil_pengerjaan['hasil_kerja_1'])) {
                                                ...
                                                if ($explode_total_hasil_kerja_1[0]==0) {
                                                    ...
                                                    $list_umk_1 = \App\Models\UMKBoronganEkspor::where('id',$explode_total_hasil_kerja_1[0])->first();
                                            ...
                                            if (empty($hasil_pengerjaan['hasil_kerja_2'])) {
                                                ...
                                                if ($explode_total_hasil_kerja_2[0]==0) {
                                                    ...
                                                    $list_umk_2 = \App\Models\UMKBoronganEkspor::where('id',$explode_total_hasil_kerja_2[0])->first();
                                            ...
                                            if (empty($hasil_pengerjaan['hasil_kerja_3'])) {
                                                ...
                                                if ($explode_total_hasil_kerja_3[0]==0) {
                                                    ...
                                                    $list_umk_3 = \App\Models\UMKBoronganEkspor::where('id',$explode_total_hasil_kerja_3[0])->first();
                                            ...
                                            if (empty($hasil_pengerjaan['hasil_kerja_4'])) {
                                                ...
                                                if ($explode_total_hasil_kerja_4[0]==0) {
                                                    ...
                                                    $list_umk_4 = \App\Models\UMKBoronganEkspor::where('id',$explode_total_hasil_kerja_4[0])->first();
                                            ...
                                            if (empty($hasil_pengerjaan['hasil_kerja_5'])) {
                                                ...
                                                if ($explode_total_hasil_kerja_5[0]==0) {
                                                    ...
                                                    $list_umk_5 = \App\Models\UMKBoronganEkspor::where('id',$explode_total_hasil_kerja_5[0])->first();
