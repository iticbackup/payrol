    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                {{-- <form action="{{ route('hasil_kerja.kemasEkspor.view_hasil.simpan',['id' => $id, 'kode_pengerjaan' => $kode_pengerjaan, 'tanggal' => $tanggal]) }}" method="post" enctype="multipart/form-data"> --}}
                            ...
                            <tr>
                                <th class="text-center" style="width: 10%">
                                    ...
                                    <select name="umk_borongan_lokal_kerja_1" class="form-control" id="">
                                        ...
                                        @foreach ($umk_borongan_ekspors as $umk_borongan_ekspor)
                                            <option value="{{ $umk_borongan_ekspor->id }}" {{ $umk_borongan_ekspor->id == $select_umk_borongan_lokal_1 ? 'selected' : null }}>{{ $umk_borongan_ekspor->jenis_produk }} - Rp {{ $umk_borongan_ekspor->umk_kemas }}</option>
                                        @endforeach
                                    </select>
                                </th>
                                ...
                                <th class="text-center" style="width: 10%">
                                    <select name="umk_borongan_lokal_kerja_2" class="form-control" id="">
                                        ...
                                        {{-- {{ dd($umk_borongan_lokal->id) }} --}}
                                            <option value="{{ $umk_borongan_ekspor->id }}" {{ $umk_borongan_ekspor->id == $select_umk_borongan_lokal_2 ? 'selected' : null }}>{{ $umk_borongan_ekspor->jenis_produk }} - Rp {{ $umk_borongan_ekspor->umk_kemas }}</option>
                                        @endforeach
                                    </select>
                                </th>
                                <th class="text-center">
                                ...
                                <th class="text-center" style="width: 10%">
                                    <select name="umk_borongan_lokal_kerja_3" class="form-control" id="">
                                        <option value="">-- Pilih --</option>
                                        @foreach ($umk_borongan_ekspors as $umk_borongan_ekspor)
                                            <option value="{{ $umk_borongan_ekspor->id }}" {{ $umk_borongan_ekspor->id == $select_umk_borongan_lokal_3 ? 'selected' : null }}>{{ $umk_borongan_ekspor->jenis_produk }} - Rp {{ $umk_borongan_ekspor->umk_kemas }}</option>
                                        @endforeach
                                    </select>
                                </th>
                                <th class="text-center">
                                ...
                                <th class="text-center" style="width: 10%">
                                    <select name="umk_borongan_lokal_kerja_4" class="form-control" id="">
                                        <option value="">-- Pilih --</option>
                                        @foreach ($umk_borongan_ekspors as $umk_borongan_ekspor)
                                            <option value="{{ $umk_borongan_ekspor->id }}" {{ $umk_borongan_ekspor->id == $select_umk_borongan_lokal_4 ? 'selected' : null }}>{{ $umk_borongan_ekspor->jenis_produk }} - Rp {{ $umk_borongan_ekspor->umk_kemas }}</option>
                                        @endforeach
                                    </select>
                                </th>
                                <th class="text-center">
                                ...
                                <th class="text-center" style="width: 10%">
                                    <select name="umk_borongan_lokal_kerja_5" class="form-control" id="">
                                        <option value="">-- Pilih --</option>
                                        @foreach ($umk_borongan_ekspors as $umk_borongan_ekspor)
                                            <option value="{{ $umk_borongan_ekspor->id }}" {{ $umk_borongan_ekspor->id == $select_umk_borongan_lokal_5 ? 'selected' : null }}>{{ $umk_borongan_ekspor->jenis_produk }} - Rp {{ $umk_borongan_ekspor->umk_kemas }}</option>
                                        @endforeach
                                    </select>
                                </th>
                                <th class="text-center">
...
<script>
    ...
    $('#form-simpan').submit(function(e) {
        ...
        $.ajax({
            type:'POST',
            url:"{{ url('pengerjaan/hasil_kerja/kemas_ekspor/'.$id.'/'.$kode_pengerjaan.'/'.$tanggal.'/input_hasil/simpan') }}",
            data: formData,
            contentType: false,
            processData: false,
            success: (result) => {
