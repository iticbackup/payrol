                        ...
                        <table class="table table-sm table-bordered dt-responsive nowrap"
                            ...
                            <tbody>
                                ...
                                @foreach ($pengerjaan_supir_rits as $key => $pengerjaan_supir_rit)
                                    @php
                                        // $pengerjaan_supir_rit_dailys = \App\Models\PengerjaanRITHarian::where('')
                                        // $umk_rit = \App\Models\RitUMK::select('kategori_upah')->where('id',$pengerjaan_supir_rit->rit_posisi_id)->first();
                                        // echo json_encode($umk_rit);
                                        $upah_dasar = [];
                                    ...
                                    <tr>
                                        ...
                                        @endif
                                        {{-- <td><a href="{{ route('hasil_kerja.supir_rit.view_hasil_karyawan',['kode_pengerjaan' => $kode_pengerjaan, 'nik' => $pengerjaan_supir_rit->nik]) }}" class="text-primary">{{ $pengerjaan_supir_rit->nama }}</a></td> --}}
                                                ...
                                                <td style="font-size: 8pt;">
                                                    <table class="table" style="width: 100%">
                                                        <tr>
                                                            ...
                                                            <td><span class="text-primary">{{ $hasil_kerja_1 }}</span></td>
                                                            <td>-</td>
                                                        ...
                                                        <td><span class="text-danger">{{ $hasil_umk_rit }}</span></td>
                                                        <td>-</td>
                                                        <td><span class="text-danger">{{ $hasil_kerja_1 }}</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td>DPB</td>
                                                        <td>:</td>
                                                        <td colspan="3"><span class="text-danger">Rp. {{ number_format($dpb,0,',','.') }}</td>
                                                    </tr> --}}
                                                    </table>
                                                    {{-- <span style="font-size: 8pt" class="text-primary">KODE : <span class="text-danger">{{ $hasil_umk_rit }}</span> - <span class="text-danger">{{ $hasil_kerja_1 }}</span></span>
                                                <span style="font-size: 8pt" class="text-primary">DPB : <span class="text-danger">Rp. {{ number_format($dpb,0,',','.') }}</span></span> --}}
                                                </td>
                                            @endif
                                        @endforeach
                                        @php
                                        ...
                                        @endphp
                                        <td style="text-align: right">Rp. {{ number_format($hasil_upah_dasar, 0, ',', '.') }}
                                        </td>
                                        ...
                                        <td style="text-align: right">Rp. {{ number_format($bpjs_kesehatan, 0, ',', '.') }}
                                        </td>
                                        {{-- <td style="text-align: right">Rp. {{ number_format($pensiun,0,',','.') }}</td> --}}
                                        <td style="text-align: right">Rp.
                                            {{ number_format($total_upah_diterima, 0, ',', '.') }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                            <tfoot>
                                <tr>
                                    ...
                                    {{-- <td style="text-align: right; font-weight: bold">Rp. {{ number_format(array_sum($total_all_pensiun),0,',','.') }}</td> --}}
                                    <td style="text-align: right; font-weight: bold">Rp.
