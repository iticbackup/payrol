                                ...
                                ?>
                                    <tr>
                                        ...
                                        <?php 
                                            ...
                                            $umk_borongan_lokal_1 = \App\Models\UMKBoronganAmbri::select('id','jenis_produk','umk_ambri','target_ambri')->where('id',$explode_hasil_kerja_1[0])->first();
                                            if(empty($umk_borongan_lokal_1)){
                                                ...
                                                if ((int)$data_explode_hasil_kerja_1 >= $umk_borongan_lokal_1->target_ambri) {
                                                    $icon_target_1 = "<span class='badge badge-soft-info btn-sm'>T</span>";
                                                }else{
                                                    $icon_target_1 = null;
                                                }

                                                // dd((int)$data_explode_hasil_kerja_1.' '.$umk_borongan_lokal_1->target_ambri);
                                                // dd($explode_status_lembur);
                                                // dd($hasil_pengerjaan->lembur);
                                            }
    
                                            $explode_hasil_kerja_2 = explode("|",$hasil_pengerjaan->hasil_kerja_2);
                                            $umk_borongan_lokal_2 = \App\Models\UMKBoronganAmbri::select('id','jenis_produk','umk_ambri','target_ambri')->where('id',$explode_hasil_kerja_2[0])->first();
                                            if(empty($umk_borongan_lokal_2)){
                                                ...
                                                if ((int)$data_explode_hasil_kerja_2 >= $umk_borongan_lokal_2->target_ambri) {
                                            ...
                                            $umk_borongan_lokal_3 = \App\Models\UMKBoronganAmbri::select('id','jenis_produk','umk_ambri','target_ambri')->where('id',$explode_hasil_kerja_3[0])->first();
                                            if(empty($umk_borongan_lokal_3)){
                                                ...
                                                if ((int)$data_explode_hasil_kerja_3 >= $umk_borongan_lokal_3->target_ambri) {
                                            ...
                                            $umk_borongan_lokal_4 = \App\Models\UMKBoronganAmbri::select('id','jenis_produk','umk_ambri','target_ambri')->where('id',$explode_hasil_kerja_4[0])->first();
                                            if(empty($umk_borongan_lokal_4)){
                                                ...
                                                if ((int)$data_explode_hasil_kerja_4 >= $umk_borongan_lokal_4->target_ambri) {
                                            ...
                                            $umk_borongan_lokal_5 = \App\Models\UMKBoronganAmbri::select('id','jenis_produk','umk_ambri','target_ambri')->where('id',$explode_hasil_kerja_5[0])->first();
                                            if(empty($umk_borongan_lokal_5)){
                                                ...
                                                if ((int)$data_explode_hasil_kerja_5 >= $umk_borongan_lokal_5->target_ambri) {
