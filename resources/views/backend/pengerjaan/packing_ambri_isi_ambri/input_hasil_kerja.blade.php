    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                {{-- <form action="{{ route('hasil_kerja.isiAmbri.view_hasil.simpan',['id' => $id, 'kode_pengerjaan' => $kode_pengerjaan, 'tanggal' => $tanggal]) }}" method="post" enctype="multipart/form-data"> --}}
                ...
                <div class="card-body">
                    ...
                    style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tr>
                                <th class="text-center" style="width: 10%">
                                    ...
                                    <select name="umk_borongan_lokal_kerja_1" class="form-control" id="">
                                        ...
                                        @foreach ($umk_borongan_ambris as $umk_borongan_ambri)
                                            <option value="{{ $umk_borongan_ambri->id }}" {{ $umk_borongan_ambri->id == $select_umk_borongan_lokal_1 ? 'selected' : null }}>{{ $umk_borongan_ambri->jenis_produk }} - Rp {{ $umk_borongan_ambri->umk_ambri }}</option>
                                        @endforeach
                                    </select>
                                </th>
                                ...
                                <th class="text-center" style="width: 10%">
                                    <select name="umk_borongan_lokal_kerja_2" class="form-control" id="">
                                        ...
                                        {{-- {{ dd($umk_borongan_lokal->id) }} --}}
                                            <option value="{{ $umk_borongan_ambri->id }}" {{ $umk_borongan_ambri->id == $select_umk_borongan_lokal_2 ? 'selected' : null }}>{{ $umk_borongan_ambri->jenis_produk }} - Rp {{ $umk_borongan_ambri->umk_ambri }}</option>
                                        @endforeach
                                    </select>
                                </th>
                                <th class="text-center">
                                ...
                                <th class="text-center" style="width: 10%">
                                    <select name="umk_borongan_lokal_kerja_3" class="form-control" id="">
                                        <option value="">-- Pilih --</option>
                                        @foreach ($umk_borongan_ambris as $umk_borongan_ambri)
                                            <option value="{{ $umk_borongan_ambri->id }}" {{ $umk_borongan_ambri->id == $select_umk_borongan_lokal_3 ? 'selected' : null }}>{{ $umk_borongan_ambri->jenis_produk }} - Rp {{ $umk_borongan_ambri->umk_ambri }}</option>
                                        @endforeach
                                    </select>
                                </th>
                                <th class="text-center">
                                ...
                                <th class="text-center" style="width: 10%">
                                    <select name="umk_borongan_lokal_kerja_4" class="form-control" id="">
                                        <option value="">-- Pilih --</option>
                                        @foreach ($umk_borongan_ambris as $umk_borongan_ambri)
                                            <option value="{{ $umk_borongan_ambri->id }}" {{ $umk_borongan_ambri->id == $select_umk_borongan_lokal_4 ? 'selected' : null }}>{{ $umk_borongan_ambri->jenis_produk }} - Rp {{ $umk_borongan_ambri->umk_ambri }}</option>
                                        @endforeach
                                    </select>
                                </th>
                                <th class="text-center">
                                ...
                                <th class="text-center" style="width: 10%">
                                    <select name="umk_borongan_lokal_kerja_5" class="form-control" id="">
                                        <option value="">-- Pilih --</option>
                                        @foreach ($umk_borongan_ambris as $umk_borongan_ambri)
                                            <option value="{{ $umk_borongan_ambri->id }}" {{ $umk_borongan_ambri->id == $select_umk_borongan_lokal_5 ? 'selected' : null }}>{{ $umk_borongan_ambri->jenis_produk }} - Rp {{ $umk_borongan_ambri->umk_ambri }}</option>
                                        @endforeach
                                    </select>
                                </th>
                                <th class="text-center">
                        ...
                        <tbody>
                            @foreach ($packing_ambris as $key=> $packing_ambri)
                                {{-- <?php 
                                    $explode_hasil_kerja_1 = explode("|",$packing_ambri->hasil_kerja_1);
                                ...
                                <?php 
                                    if(empty($packing_ambri->hasil_kerja_1)){
                                        $hasil_kerja_1 = null;
                                    }else{
                                        $explode_hasil_kerja_1 = explode("|",$packing_ambri->hasil_kerja_1);
                                        $hasil_kerja_1 = $explode_hasil_kerja_1[1];
                                    ...
                                    if(empty($packing_ambri->hasil_kerja_2)){
                                        $hasil_kerja_2 = null;
                                    }else{
                                        $explode_hasil_kerja_2 = explode("|",$packing_ambri->hasil_kerja_2);
                                        $hasil_kerja_2 = $explode_hasil_kerja_2[1];
                                    }

                                    if(empty($packing_ambri->hasil_kerja_3)){
                                        $hasil_kerja_3 = null;
                                    }else{
                                        $explode_hasil_kerja_3 = explode("|",$packing_ambri->hasil_kerja_3);
                                        $hasil_kerja_3 = $explode_hasil_kerja_3[1];
                                    }

                                    if(empty($packing_ambri->hasil_kerja_4)){
                                        $hasil_kerja_4 = null;
                                    }else{
                                        $explode_hasil_kerja_4 = explode("|",$packing_ambri->hasil_kerja_4);
                                        $hasil_kerja_4 = $explode_hasil_kerja_4[1];
                                    }

                                    if(empty($packing_ambri->hasil_kerja_5)){
                                        $hasil_kerja_5 = null;
                                    }else{
                                        $explode_hasil_kerja_5 = explode("|",$packing_ambri->hasil_kerja_5);
                                        $hasil_kerja_5 = $explode_hasil_kerja_5[1];
                                    }
                                ?>
                                <tr>
                                    <td class="text-center">{{ $key+1 }}</td>
                                    <td>{{ $packing_ambri->nik }}</td>
                                    <td>{{ $packing_ambri->nama }}</td>
                                    <td style="width: 5%"><input type="text" name="hasil_kerja_1[]" value="{{ $hasil_kerja_1 }}" class="form-control" style="text-align: center" id="" placeholder="Hasil Kerja 1"></td>
                                    <td style="width: 5%">
                                        <div class="input-group">
                                            <input type="text" name="total_jam_1[]" value="{{ $packing_ambri->total_jam_kerja_1 }}" style="background-color: #E1ECC8; text-align: center" class="form-control">
                                            {{-- <span class="input-group-text" id="basic-addon2">Jam</span> --}}
                                        </div>
                                    </td>
                                    <td style="width: 5%"><input type="text" name="hasil_kerja_2[]" value="{{ $hasil_kerja_2 }}" class="form-control" style="text-align: center" id="" placeholder="Hasil Kerja 2"></td>
                                    <td style="width: 5%">
                                        <div class="input-group">
                                            <input type="text" name="total_jam_2[]" value="{{ $packing_ambri->total_jam_kerja_2 }}" style="background-color: #E1ECC8; text-align: center" class="form-control">
                                            {{-- <span class="input-group-text" id="basic-addon2">Jam</span> --}}
                                        </div>
                                    </td>
                                    <td style="width: 5%"><input type="text" name="hasil_kerja_3[]" value="{{ $hasil_kerja_3 }}" class="form-control" style="text-align: center" id="" placeholder="Hasil Kerja 3"></td>
                                    <td style="width: 5%">
                                        <div class="input-group">
                                            <input type="text" name="total_jam_3[]" value="{{ $packing_ambri->total_jam_kerja_3 }}" style="background-color: #E1ECC8; text-align: center" class="form-control">
                                            {{-- <span class="input-group-text" id="basic-addon2">Jam</span> --}}
                                        </div>
                                    </td>
                                    <td style="width: 5%"><input type="text" name="hasil_kerja_4[]" value="{{ $hasil_kerja_4 }}" class="form-control" style="text-align: center" id="" placeholder="Hasil Kerja 4"></td>
                                    <td style="width: 5%">
                                        <div class="input-group">
                                            <input type="text" name="total_jam_4[]" value="{{ $packing_ambri->total_jam_kerja_4 }}" style="background-color: #E1ECC8; text-align: center" class="form-control">
                                            {{-- <span class="input-group-text" id="basic-addon2">Jam</span> --}}
                                        </div>
                                    </td>
                                    <td style="width: 5%"><input type="text" name="hasil_kerja_5[]" value="{{ $hasil_kerja_5 }}" class="form-control" style="text-align: center" id="" placeholder="Hasil Kerja 5"></td>
                                    <td style="width: 5%">
                                        <div class="input-group">
                                            <input type="text" name="total_jam_5[]" value="{{ $packing_ambri->total_jam_kerja_5 }}" style="background-color: #E1ECC8; text-align: center" class="form-control">
                                            {{-- <span class="input-group-text" id="basic-addon2">Jam</span> --}}
                                        </div>
                                    </td>
                                </tr>
...
<script>
    ...
    $('#form-simpan').submit(function(e) {
        ...
        $.ajax({
            type:'POST',
            url:"{{ url('pengerjaan/hasil_kerja/isi_ambri/'.$id.'/'.$kode_pengerjaan.'/'.$tanggal.'/input_hasil/simpan') }}",
            data: formData,
            contentType: false,
            processData: false,
            success: (result) => {
