...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                {{-- <form action="{{ route('hasil_kerja.bandrolLokal.view_hasil_karyawan.simpan',['id' => $id, 'kode_pengerjaan' => $kode_pengerjaan,'nik' => $nik]) }}" method="post" enctype="multipart/form-data"> --}}
...
@section('script')
    ...
    <script>
        $('#form-simpan').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ url('pengerjaan/hasil_kerja/bandrol_lokal/' . $id . '/' . $kode_pengerjaan . '/' . $nik . '/input_hasil_karyawan/simpan') }}",
                data: formData,
                contentType: false,
                processData: false,
                success: (result) => {
