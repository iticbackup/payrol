                                ...
                                ?>
                                    <tr>
                                        ...
                                        <?php 
                                            ...
                                            $umk_borongan_lokal_1 = \App\Models\UMKBoronganLokal::select('id','jenis_produk','umk_outer','target_outer')->where('id',$explode_hasil_kerja_1[0])->first();
                                            if(empty($umk_borongan_lokal_1)){
                                                ...
                                                if ((int)$data_explode_hasil_kerja_1 >= $umk_borongan_lokal_1->target_outer) {
                                            ...
                                            $umk_borongan_lokal_2 = \App\Models\UMKBoronganLokal::select('id','jenis_produk','umk_outer','target_outer')->where('id',$explode_hasil_kerja_2[0])->first();
                                            if(empty($umk_borongan_lokal_2)){
                                                ...
                                                if ((int)$data_explode_hasil_kerja_2 >= $umk_borongan_lokal_2->target_outer) {
                                            ...
                                            $umk_borongan_lokal_3 = \App\Models\UMKBoronganLokal::select('id','jenis_produk','umk_outer','target_outer')->where('id',$explode_hasil_kerja_3[0])->first();
                                            if(empty($umk_borongan_lokal_3)){
                                                ...
                                                if ((int)$data_explode_hasil_kerja_3 >= $umk_borongan_lokal_3->target_outer) {
                                            ...
                                            $umk_borongan_lokal_4 = \App\Models\UMKBoronganLokal::select('id','jenis_produk','umk_outer','target_outer')->where('id',$explode_hasil_kerja_4[0])->first();
                                            if(empty($umk_borongan_lokal_4)){
                                                ...
                                                if ((int)$data_explode_hasil_kerja_4 >= $umk_borongan_lokal_4->target_outer) {
                                            ...
                                            $umk_borongan_lokal_5 = \App\Models\UMKBoronganLokal::select('id','jenis_produk','umk_outer','target_outer')->where('id',$explode_hasil_kerja_5[0])->first();
                                            if(empty($umk_borongan_lokal_5)){
                                                ...
                                                if ((int)$data_explode_hasil_kerja_5 >= $umk_borongan_lokal_5->target_outer) {
