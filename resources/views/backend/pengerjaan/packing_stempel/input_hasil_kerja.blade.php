                            ...
                            <tr>
                                <th class="text-center" style="width: 10%">
                                    ...
                                    <select name="umk_borongan_lokal_kerja_1" class="form-control" id="">
                                        ...
                                        @foreach ($umk_borongan_stempel_lokals as $umk_borongan_stempel_lokal)
                                            <option value="{{ $umk_borongan_stempel_lokal->id }}" {{ $umk_borongan_stempel_lokal->id == $select_umk_borongan_lokal_1 ? 'selected' : null }}>{{ $umk_borongan_stempel_lokal->jenis_produk }} - Rp {{ $umk_borongan_stempel_lokal->nominal_umk }}</option>
                                        @endforeach
                                    </select>
                                </th>
                                ...
                                <th class="text-center" style="width: 10%">
                                    <select name="umk_borongan_lokal_kerja_2" class="form-control" id="">
                                        <option value="">-- Pilih --</option>
                                        @foreach ($umk_borongan_stempel_lokals as $umk_borongan_stempel_lokal)
                                            <option value="{{ $umk_borongan_stempel_lokal->id }}" {{ $umk_borongan_stempel_lokal->id == $select_umk_borongan_lokal_2 ? 'selected' : null }}>{{ $umk_borongan_stempel_lokal->jenis_produk }} - Rp {{ $umk_borongan_stempel_lokal->nominal_umk }}</option>
                                        @endforeach
                                    </select>
                                </th>
                                <th class="text-center">
                                ...
                                <th class="text-center" style="width: 10%">
                                    <select name="umk_borongan_lokal_kerja_3" class="form-control" id="">
                                        <option value="">-- Pilih --</option>
                                        @foreach ($umk_borongan_stempel_lokals as $umk_borongan_stempel_lokal)
                                            <option value="{{ $umk_borongan_stempel_lokal->id }}" {{ $umk_borongan_stempel_lokal->id == $select_umk_borongan_lokal_3 ? 'selected' : null }}>{{ $umk_borongan_stempel_lokal->jenis_produk }} - Rp {{ $umk_borongan_stempel_lokal->nominal_umk }}</option>
                                        @endforeach
                                    </select>
                                </th>
                                <th class="text-center">
                                ...
                                <th class="text-center" style="width: 10%">
                                    <select name="umk_borongan_lokal_kerja_4" class="form-control" id="">
                                        <option value="">-- Pilih --</option>
                                        @foreach ($umk_borongan_stempel_lokals as $umk_borongan_stempel_lokal)
                                            <option value="{{ $umk_borongan_stempel_lokal->id }}" {{ $umk_borongan_stempel_lokal->id == $select_umk_borongan_lokal_4 ? 'selected' : null }}>{{ $umk_borongan_stempel_lokal->jenis_produk }} - Rp {{ $umk_borongan_stempel_lokal->nominal_umk }}</option>
                                        @endforeach
                                    </select>
                                </th>
                                <th class="text-center">
                                ...
                                <th class="text-center" style="width: 10%">
                                    <select name="umk_borongan_lokal_kerja_5" class="form-control" id="">
                                        <option value="">-- Pilih --</option>
                                        @foreach ($umk_borongan_stempel_lokals as $umk_borongan_stempel_lokal)
                                            <option value="{{ $umk_borongan_stempel_lokal->id }}" {{ $umk_borongan_stempel_lokal->id == $select_umk_borongan_lokal_5 ? 'selected' : null }}>{{ $umk_borongan_stempel_lokal->jenis_produk }} - Rp {{ $umk_borongan_stempel_lokal->nominal_umk }}</option>
                                        @endforeach
                                    </select>
                                </th>
                                <th class="text-center">
...
<script>
    ...
    $('#form-simpan').submit(function(e) {
        ...
        $.ajax({
            type:'POST',
            url:"{{ url('pengerjaan/hasil_kerja/stempel_lokal/'.$id.'/'.$kode_pengerjaan.'/'.$tanggal.'/input_hasil/simpan') }}",
            data: formData,
            contentType: false,
            processData: false,
            success: (result) => {
