    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                {{-- <form action="{{ route('hasil_kerja.gagangEkspor.view_hasil.simpan',['id' => $id, 'kode_pengerjaan' => $kode_pengerjaan, 'tanggal' => $tanggal]) }}" method="post" enctype="multipart/form-data"> --}}
                            ...
                            <tr>
                                <th class="text-center" style="width: 10%">
                                    ...
                                    <select name="umk_borongan_lokal_kerja_1" class="form-control" id="">
                                        ...
                                        @foreach ($umk_borongan_ekspors as $umk_borongan_ekspor)
                                            <option value="{{ $umk_borongan_ekspor->id }}" {{ $umk_borongan_ekspor->id == $select_umk_borongan_lokal_1 ? 'selected' : null }}>{{ $umk_borongan_ekspor->jenis_produk }} - Rp {{ $umk_borongan_ekspor->umk_pilih_gagang }}</option>
                                        @endforeach
                                    </select>
                                </th>
                                ...
                                <th class="text-center" style="width: 10%">
                                    <select name="umk_borongan_lokal_kerja_2" class="form-control" id="">
                                        ...
                                        {{-- {{ dd($umk_borongan_lokal->id) }} --}}
                                            <option value="{{ $umk_borongan_ekspor->id }}" {{ $umk_borongan_ekspor->id == $select_umk_borongan_lokal_2 ? 'selected' : null }}>{{ $umk_borongan_ekspor->jenis_produk }} - Rp {{ $umk_borongan_ekspor->umk_pilih_gagang }}</option>
                                        @endforeach
                                    </select>
                                </th>
                                <th class="text-center">
                                ...
                                <th class="text-center" style="width: 10%">
                                    <select name="umk_borongan_lokal_kerja_3" class="form-control" id="">
                                        <option value="">-- Pilih --</option>
                                        @foreach ($umk_borongan_ekspors as $umk_borongan_ekspor)
                                            <option value="{{ $umk_borongan_ekspor->id }}" {{ $umk_borongan_ekspor->id == $select_umk_borongan_lokal_3 ? 'selected' : null }}>{{ $umk_borongan_ekspor->jenis_produk }} - Rp {{ $umk_borongan_ekspor->umk_pilih_gagang }}</option>
                                        @endforeach
                                    </select>
                                </th>
                                <th class="text-center">
                                ...
                                <th class="text-center" style="width: 10%">
                                    <select name="umk_borongan_lokal_kerja_4" class="form-control" id="">
                                        <option value="">-- Pilih --</option>
                                        @foreach ($umk_borongan_ekspors as $umk_borongan_ekspor)
                                            <option value="{{ $umk_borongan_ekspor->id }}" {{ $umk_borongan_ekspor->id == $select_umk_borongan_lokal_4 ? 'selected' : null }}>{{ $umk_borongan_ekspor->jenis_produk }} - Rp {{ $umk_borongan_ekspor->umk_pilih_gagang }}</option>
                                        @endforeach
                                    </select>
                                </th>
                                <th class="text-center">
                                ...
                                <th class="text-center" style="width: 10%">
                                    <select name="umk_borongan_lokal_kerja_5" class="form-control" id="">
                                        <option value="">-- Pilih --</option>
                                        @foreach ($umk_borongan_ekspors as $umk_borongan_ekspor)
                                            <option value="{{ $umk_borongan_ekspor->id }}" {{ $umk_borongan_ekspor->id == $select_umk_borongan_lokal_5 ? 'selected' : null }}>{{ $umk_borongan_ekspor->jenis_produk }} - Rp {{ $umk_borongan_ekspor->umk_pilih_gagang }}</option>
                                        @endforeach
                                    </select>
                                </th>
                                <th class="text-center">
                        ...
                        <tbody>
                            @foreach ($packing_ekspors as $key=> $packing_ekspor)
                                ...
                                <tr>
                                    ...
                                    <td style="width: 5%">
                                        <div class="input-group">
                                            <input type="text" name="total_jam_1[]" style="background-color: #E1ECC8; text-align: center" class="form-control">
                                            {{-- <span class="input-group-text" id="basic-addon2">Jam</span> --}}
                                        </div>
                                    </td>
                                    ...
                                    <td style="width: 5%">
                                        <div class="input-group">
                                            <input type="text" name="total_jam_2[]" style="background-color: #E1ECC8; text-align: center" class="form-control">
                                            {{-- <span class="input-group-text" id="basic-addon2">Jam</span> --}}
                                        </div>
                                    </td>
                                    ...
                                    <td style="width: 5%">
                                        <div class="input-group">
                                            <input type="text" name="total_jam_3[]" style="background-color: #E1ECC8; text-align: center" class="form-control">
                                            {{-- <span class="input-group-text" id="basic-addon2">Jam</span> --}}
                                        </div>
                                    </td>
                                    ...
                                    <td style="width: 5%">
                                        <div class="input-group">
                                            <input type="text" name="total_jam_4[]" style="background-color: #E1ECC8; text-align: center" class="form-control">
                                            {{-- <span class="input-group-text" id="basic-addon2">Jam</span> --}}
                                        </div>
                                    </td>
                                    ...
                                    <td style="width: 5%">
                                        <div class="input-group">
                                            <input type="text" name="total_jam_5[]" style="background-color: #E1ECC8; text-align: center" class="form-control">
                                            {{-- <span class="input-group-text" id="basic-addon2">Jam</span> --}}
                                        </div>
                                    </td>
                                </tr>
...
<script>
    ...
    $('#form-simpan').submit(function(e) {
        ...
        $.ajax({
            type:'POST',
            url:"{{ url('pengerjaan/hasil_kerja/gagang_ekspor/'.$id.'/'.$kode_pengerjaan.'/'.$tanggal.'/input_hasil/simpan') }}",
            data: formData,
            contentType: false,
            processData: false,
            success: (result) => {
