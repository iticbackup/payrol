                        ...
                        <tbody>
                            @foreach ($check_kirim_gajis as $key => $check_kirim_gaji)
                                <tr>
                                    ...
                                    <td>
                                        @if (empty($check_kirim_gaji->karyawan_operator_harian->jenis_operator_detail_pengerjaan))
                                            {{ $check_kirim_gaji->karyawan_operator_harian->jenis_operator->jenis_operator }}
                                        @else
                                            {{ $check_kirim_gaji->karyawan_operator_harian->jenis_operator->jenis_operator.' - '.$check_kirim_gaji->karyawan_operator_harian->jenis_operator_detail_pengerjaan->jenis_posisi_pekerjaan }}
                                        @endif
                                    </td>
                                    {{-- <td>{{ $check_kirim_gaji->karyawan_operator_harian->jenis_operator->jenis_operator.' - '.$check_kirim_gaji->karyawan_operator_harian->jenis_operator_detail_pengerjaan->jenis_posisi_pekerjaan }}</td> --}}
