...
@section('title')
    Detail Slip Gaji Borongan - {{ $new_data_pengerjaan->kode_pengerjaan }}
@endsection
@section('css')
                        ...
                        <tbody>
                            @foreach ($slip_gaji_borongans as $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn btn-primary" onclick="resend_mail(`{{ $new_data_pengerjaan->kode_pengerjaan }}`,{{ $item->id }})">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 512 512">
