...
@section('content')
    ...
    @include('backend.payrol.operator_karyawan_harian.modalBuat')
    @include('backend.payrol.operator_karyawan_harian.modalEdit')
...
@section('script')
    ...
    <script>
        ...
        var table = $('#datatables').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('operator_karyawan_harian') }}",
            columns: [
                // {
                //     data: 'id',
                //     name: 'id'
        ...
        $('#form-simpan').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('operator_karyawan_harian_simpan') }}",
                data: formData,
                contentType: false,
                processData: false,
                success: (result) => {
        ...
        function edit(id) {
            var url = '{{ route('operator_karyawan_harian_detail', ':id') }}';
            ...
            $.ajax({
                ...
                success: (result) => {
                    ...
                    $('#edit_hari_kerja').val(result.data.hari_kerja);
        ...
        $('#form-update').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('operator_karyawan_harian_update') }}",
                data: formData,
                contentType: false,
                processData: false,
                success: (result) => {
        ...
        function hapus(id) {
            swal.fire({
                ...
                if (result.value) {
                    ...
                    // let formData = new FormData(this);
                    // $('#image-input-error').text('');
                    var url = '{{ route('operator_karyawan_harian_hapus', ':id') }}';
                    url = url.replace(':id', id);
                    $.ajax({
                        type:'GET',
                        url: url,
