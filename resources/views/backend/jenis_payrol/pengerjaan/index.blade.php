...
@section('title')
    Jenis Operator - {{ $jenis_operator_detail->jenis_posisi }}
@endsection
...
@section('content')
    ...
    @include('backend.jenis_payrol.pengerjaan.modalBuat')
...
<script>
    ...
    var table = $('#datatables').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('jenis_operator.detail.pengerjaan',['id' => $id, 'id_pengerjaan' => $jenis_operator_detail->id]) }}",
        columns: [
            {
                data: 'jenis_posisi_pekerjaan',
                name: 'jenis_posisi_pekerjaan'
            },
            {
                data: 'status',
                name: 'status'
    ...
    $('#form-simpan').submit(function(e) {
        ...
        $.ajax({
            type:'POST',
            url: "{{ route('jenis_operator.detail.pengerjaan.simpan',['id' => $id, 'id_pengerjaan' => $jenis_operator_detail->id]) }}",
            data: formData,
            contentType: false,
            processData: false,
            success: (result) => {
