    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title m-0" id="exampleModalCenterTitle">Edit Data BPJS JHT</h6>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="edit_masa_kerja" id="edit_masa_kerja" placeholder="Masa Kerja">
                        </div>
                        <div class="mb-3">
