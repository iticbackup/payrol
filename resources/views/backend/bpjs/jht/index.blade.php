...
@section('content')
    ...
    @include('backend.bpjs.jht.modalBuat')
    @include('backend.bpjs.jht.modalEdit')
...
@section('script')
    ...
    <script>
        ...
        function edit(id) {
            var url = '{{ route('bpjs.jht.detail', ':id') }}';
        ...
        function hapus(id) {
            var url = '{{ route('bpjs.jht.delete', ':id') }}';
            url = url.replace(':id', id);
