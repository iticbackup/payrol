...
class PengerjaanController extends Controller
{
    ...
    public function hasil_kerja_stempel_lokal($id, $kode_pengerjaan)
    {
        if($id == 1){
            $kode_jenis_operator_detail = 'L';
        }
        ...
        $data['id'] = $id;
        $data['kode_pengerjaan'] = $kode_pengerjaan;
        $data['jenis_operator_detail_pekerjaan'] = $this->jenisOperatorDetailPengerjaan->find(25);
        $data['new_data_pengerjaan'] = $this->newDataPengerjaan->where('kode_pengerjaan',$kode_pengerjaan)->first();
        $data['explode_tanggal_pengerjaans'] = explode('#',$data['new_data_pengerjaan']['tanggal']);
        $data['count_tanggal'] = count($data['explode_tanggal_pengerjaans'])-1;
        ...
        $data['pengerjaans'] = $this->pengerjaanWeekly->select([
                                                    ...
                                                    ->where('operator_karyawan.jenis_operator_id',1)
                                                    ->where('operator_karyawan.jenis_operator_detail_id',1)
                                                    ->where('operator_karyawan.jenis_operator_detail_pekerjaan_id',25)
                                                    ->leftJoin('operator_karyawan','operator_karyawan.id','=','pengerjaan_weekly.operator_karyawan_id')
                                                    ->leftJoin('itic_emp_new.biodata_karyawan','biodata_karyawan.nik','=','operator_karyawan.nik')
                                                    ->orderBy('biodata_karyawan.nama','asc')
                                                    ->get();
        ...
        return view('backend.pengerjaan.packing_stempel.packing_stempel',$data);
    }

    public function hasil_kerja_stempel_lokal_view_hasil($id, $kode_pengerjaan, $tanggal)
    {
        $data['id'] = $id;
        $data['kode_pengerjaan'] = $kode_pengerjaan;
        $data['tanggal'] = $tanggal;
        $data['packing_lokals'] = $this->karyawanOperator->select([
                                                    ...
                                                    ->where('jenis_operator_id',1)
                                                    ->where('jenis_operator_detail_id',1)
                                                    ->where('jenis_operator_detail_pekerjaan_id',25)
                                                    ->where('pengerjaan.tanggal_pengerjaan',$tanggal)
                                                    ->where('pengerjaan.kode_pengerjaan',$kode_pengerjaan)
                                                    // ->with('biodata_karyawan')
                                                    ->orderBy('biodata_karyawan.nama','asc')
        ...
        $data['umk_borongan_stempel_lokals'] = $this->umkBoronganStempel->select('id','jenis_produk','nominal_umk')->where('status','Y')->get();
        // dd($data);
        return view('backend.pengerjaan.packing_stempel.input_hasil_kerja',$data);
    }

    public function hasil_kerja_stempel_lokal_view_simpan(Request $request, $id, $kode_pengerjaan, $tanggal)
    {
        if($id == 1){
            $kode_jenis_operator_detail = 'L';
        }
        ...
        foreach ($data['karyawan_pengerjaans'] as $key => $karyawan_pengerjaan) {
            // dd($request->umk_borongan_lokal_kerja_1);
            if ($request->umk_borongan_lokal_kerja_1) {
                $umk_borongan_lokal_1 = $this->umkBoronganStempel->select('id','jenis_produk','nominal_umk')
                                                        ->where('id',$request->umk_borongan_lokal_kerja_1)
                                                        ->where('status','Y')
                                                        ->first();
                ...
                // dd($umk_borongan_lokal_1->nominal_umk*$request->hasil_kerja_1[$key]);

                if ($request->hasil_kerja_1[$key]) {
                    $hasil_pengerjaan_1 = $umk_borongan_lokal_1->id.'|'.$request->hasil_kerja_1[$key];
                    $hasil_kerja_1 = $umk_borongan_lokal_1->nominal_umk*$request->hasil_kerja_1[$key];
                }else{
                    $hasil_pengerjaan_1 = $umk_borongan_lokal_1->id.'|'.'0';
                    $hasil_kerja_1 = 0;
                }
            ...
            if ($request->umk_borongan_lokal_kerja_3) {
                $umk_borongan_lokal_3 = $this->umkBoronganStempel->select('id','jenis_produk','nominal_umk')
                                                        ->where('id',$request->umk_borongan_lokal_kerja_3)
                                                        ->where('status','Y')
                                                        ->first();
            ...
            if ($request->umk_borongan_lokal_kerja_4) {
                $umk_borongan_lokal_4 = $this->umkBoronganStempel->select('id','jenis_produk','nominal_umk')
                                                        ->where('id',$request->umk_borongan_lokal_kerja_4)
                                                        ->where('status','Y')
                                                        ->first();
            ...
            if ($request->umk_borongan_lokal_kerja_5) {
                $umk_borongan_lokal_5 = $this->umkBoronganStempel->select('id','jenis_produk','nominal_umk')
                                                        ->where('id',$request->umk_borongan_lokal_kerja_5)
                                                        ->where('status','Y')
                                                        ->first();
    ...
    public function hasil_kerja_karyawan_stempel_lokal_view($id, $kode_pengerjaan, $nik, $month, $year)
    {
        $data['id'] = $id;
        $data['nik'] = $nik;
        $data['kode_pengerjaan'] = $kode_pengerjaan;
        ...
        foreach ($data['pengerjaans'] as $key => $pengerjaan) {
            ...
            $explode_hasil_kerja_2 = explode("|",$pengerjaan->hasil_kerja_2);
            $umk_borongan_lokal_2 = $this->umkBoronganStempel->select('id','jenis_produk','nominal_umk')->where('id',$explode_hasil_kerja_2[0])->first();
            if(empty($umk_borongan_lokal_2)){
                $jenis_produk_2 = '-';
                $hasil_kerja_2 = null;
                $data_explode_hasil_kerja_2 = '-';
            ...
            $explode_hasil_kerja_3 = explode("|",$pengerjaan->hasil_kerja_3);
            $umk_borongan_lokal_3 = $this->umkBoronganStempel->select('id','jenis_produk','nominal_umk')->where('id',$explode_hasil_kerja_3[0])->first();
            if(empty($umk_borongan_lokal_3)){
                $jenis_produk_3 = '-';
                $hasil_kerja_3 = null;
                $data_explode_hasil_kerja_3 = '-';
            ...
            $explode_hasil_kerja_4 = explode("|",$pengerjaan->hasil_kerja_4);
            $umk_borongan_lokal_4 = $this->umkBoronganStempel->select('id','jenis_produk','nominal_umk')->where('id',$explode_hasil_kerja_4[0])->first();
            if(empty($umk_borongan_lokal_4)){
                $jenis_produk_4 = '-';
                $hasil_kerja_4 = null;
                $data_explode_hasil_kerja_4 = '-';
            ...
            $explode_hasil_kerja_5 = explode("|",$pengerjaan->hasil_kerja_5);
            $umk_borongan_lokal_5 = $this->umkBoronganStempel->select('id','jenis_produk','nominal_umk')->where('id',$explode_hasil_kerja_5[0])->first();
            if(empty($umk_borongan_lokal_5)){
                $jenis_produk_5 = '-';
                $hasil_kerja_5 = null;
                $data_explode_hasil_kerja_5 = '-';
        ...
        $data['total_potongan_tk']=$total_potongan_tk;
        return view('backend.pengerjaan.packing_stempel.input_hasil_kerja_karyawan',$data);
    }

    public function hasil_kerja_karyawan_stempel_lokal_view_simpan(Request $request, $id, $kode_pengerjaan, $nik)
    {
        // $input = $request->all();
        if($id == 1){
            $kode_jenis_operator_detail = 'L';
