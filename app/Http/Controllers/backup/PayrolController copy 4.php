    ...
    public function harian_slip_gaji($kode_pengerjaan)
    {
        ...
        foreach ($pengerjaan_harians as $key => $ph) {
            ...
            if (empty($ph->lembur)) {
                ...
                $row1_exlode_lembur = explode("|",$ph->lembur);
                if (empty($row1_exlode_lembur)) {
                    $row1_hasil_lembur = 0;
                    $row1_lembur_1 = 0;
                    $row1_lembur_2 = 0;
                }else{
                    $row1_hasil_lembur = $row1_exlode_lembur[0];
                    $row1_lembur_1 = $row1_exlode_lembur[1];
                    $row1_lembur_2 = $row1_exlode_lembur[2];
                }
            }
            // dd($lembur_1);
            ...
            if (empty($ph->tunjangan_kehadiran)) {
                ...
                $row1_tunjangan_kehadiran = $ph->tunjangan_kehadiran;
            }

            if (empty($ph->tunjangan_kerja)) {
                $row1_tunjangan_kerja = 0;
            }else{
                $row1_tunjangan_kerja = $ph->tunjangan_kerja;
            }

            if (empty($ph->uang_makan)) {
                $row1_uang_makan = 0;
            }else{
                $row1_uang_makan = $ph->uang_makan;
            }
            ...
            if (empty($ph->plus_1)) {
                ...
                $row1_explode_plus_1 = explode("|",$ph->plus_1);
                $row1_plus_1 = intval($row1_explode_plus_1[0]);
                $row1_ket_plus_1 = $row1_explode_plus_1[1];
            }
            ...
            if (empty($ph->plus_2)) {
                ...
                $row1_explode_plus_2 = explode("|",$ph->plus_2);
                $row1_plus_2 = intval($row1_explode_plus_2[0]);
                $row1_ket_plus_2 = $row1_explode_plus_2[1];
            }
            ...
            if (empty($ph->plus_3)) {
                ...
                $row1_explode_plus_3 = explode("|",$ph->plus_3);
                $row1_plus_3 = intval($row1_explode_plus_3[0]);
                $row1_ket_plus_3 = $row1_explode_plus_3[1];
            }
            ...
            if (empty($ph->minus_1)) {
                ...
                $row1_explode_minus_1 = explode("|",$ph->minus_1);
                if (empty($row1_explode_minus_1[0])) {
                    $row1_minus_1 = 0;
                }else{
                    $row1_minus_1 = intval($row1_explode_minus_1[0]);
                }
                $row1_ket_minus_1 = $row1_explode_minus_1[1];
            }
            ...
            if (empty($ph->minus_2)) {
                ...
                $row1_explode_minus_2 = explode("|",$ph->minus_2);
                if (empty($row1_explode_minus_2[0])) {
                    $row1_minus_2 = 0;
                }else{
                    $row1_minus_2 = intval($row1_explode_minus_2[0]);
                }
                $row1_ket_minus_2 = $row1_explode_minus_2[1];
            }
            ...
            if (empty($ph->bpjs_kesehatan)) {
                ...
                $row1_bpjs_kesehatan = $ph->bpjs_kesehatan;
            }

            $row1_total_gaji_diterima = ($ph->upah_dasar_weekly+$row1_hasil_lembur+$ph->tunjangan_kehadiran+$ph->tunjangan_kerja+
                                    $row1_plus_1+$row1_plus_2+$row1_plus_3+$ph->uang_makan)-
                                    ($row1_jht+$row1_bpjs_kesehatan+$row1_minus_1+$row1_minus_2);
