...
//     }
    ...
    public function borongan_kirim_slip_gaji_new($kode_pengerjaan)
    {
        $cek_kirim_slip_gajis = $this->kirim_gaji->where('kode_pengerjaan','LIKE','%PB_%')
        ...
        foreach ($cek_kirim_slip_gajis as $key => $value) {
            if (!empty($value->karyawan_operator->biodata_karyawan->email)) {
                ...
                \Log::error('Borongan '.$value->nama_karyawan.' Email Belum Tersedia.');
            }
        ...
        return response()->json([
            ...
            'message_content' => 'Kirim Slip Gaji Borongan Berhasil Terkirim'
        ]);
    }
    ...
    public function harian_kirim_slip_gaji_new($kode_pengerjaan)
    {
        ...
        return response()->json([
            'success' => true,
            'message_title' => 'Berhasil!',
            'message_content' => 'Kirim Slip Gaji Harian Berhasil Terkirim'
        ]);
    }
    ...
    public function supir_rit_kirim_slip_gaji_new($kode_pengerjaan)
    {
        ...
        foreach ($cek_kirim_slip_gajis as $key => $value) {
            if (!empty($value->karyawan_operator_supir_rit->biodata_karyawan->email)) {
                $data['explode_tanggal_pengerjaans'] = explode('#', $value->new_data_pengerjaan->tanggal);
                $data['exp_tanggals'] = array_filter($data['explode_tanggal_pengerjaans']);
                $data['a'] = count($data['exp_tanggals']);
                ...
                \Log::error('Supir RIT '.$value->nama_karyawan.' Email Belum Tersedia.');
            }
        }
        ...
        return response()->json([
            'success' => true,
            'message_title' => 'Berhasil!',
            'message_content' => 'Kirim Slip Gaji Supir RIT Berhasil Terkirim'
        ]);
    }
    ...
    public function supir_rit_cek_email_slip_gaji($kode_pengerjaan)
    {
        ...
        return view('backend.payrol.penggajian.supir_rit.detailSlipGaji2',$data);
